...
import bm.it.mobile.sample.features.main.model.FeaturesEnum
import kotlinx.android.synthetic.main.activity_main.*

class MainActivity : AppCompatActivity(),
    MainListAdapter.MainAdapterCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerview.adapter =
            MainListAdapter(createItems(), this)
    }
    ...
    private fun createItems(): List<Features> {
        ...
        list.add(
            Features(
                ...
                FeaturesEnum.LIVEDATA_KOIN.code
            )
        )
        list.add(
            Features(
                ...
                FeaturesEnum.LIVEDATA_COROUTINES.code
            )
        )
        list.add(
            Features(
                getString(R.string.button3),
                getString(R.string.text3),
                FeaturesEnum.LIVEDATA_COROUTINES_ROOM.code
            )
        )
        list.add(
            Features(
                getString(R.string.button4),
                getString(R.string.text4),
                FeaturesEnum.LIVEDATA_COROUTINES_RETROFIT.code
            )
        )
        return list
    }
